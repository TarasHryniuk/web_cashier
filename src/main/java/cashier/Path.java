...
public final class Path {
	...
	public static final String PAGE_MANAGER_MENU = "/main_menu.jsp";
	public static final String PAGE_CASHIER_MENU = "/main_menu.jsp";
	public static final String PAGE_HEIGHT_CASHIER_MENU = "/main_menu.jsp";
